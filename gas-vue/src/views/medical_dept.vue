    ...
    <div v-if="isAuth(['ROOT', 'MEDICAL_DEPT:SELECT'])">
        <el-form :inline="true" :model="dataForm" :rules="dataRule" ref="dataForm">
            ...
            <el-form-item>
                ...
                <el-button v-if="isAuth(['ROOT', 'MEDICAL_DEPT:INSERT'])" type="primary" @click="addHandle()">
                    新增
                </el-button>
                <el-button v-if="isAuth(['ROOT', 'MEDICAL_DEPT:DELETE'])" type="danger" @click="deleteHandle()">
                    批量删除
                </el-button>
            </el-form-item>
        </el-form>
        ...
        >
            ...
            <el-table-column header-align="center" align="center" width="150" label="操作">
                <template #default="scope">
                    <el-button
                        v-if="isAuth(['ROOT', 'MEDICAL_DEPT:UPDATE'])"
                        type="text"
                    ...
                    <el-button
                        v-if="isAuth(['ROOT', 'MEDICAL_DEPT:DELETE']) && scope.row.subs === 0"
                        type="text"
